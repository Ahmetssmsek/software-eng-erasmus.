def show(city, price, dist):
    ...
    if city == "Warsaw":
        dist = "Warszawa, " + dist
        url = 'https://www.olx.pl/nieruchomosci/mieszkania/wynajem/warszawa/?search%5Border%5D=created_at:desc'
    if city == "Lodz":
        dist = "Łódź, " + dist
        url = 'https://www.olx.pl/nieruchomosci/mieszkania/wynajem/lodz/?search%5Border%5D=created_at:desc'
